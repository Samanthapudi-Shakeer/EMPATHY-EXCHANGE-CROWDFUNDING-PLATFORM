...
<html lang="en">
    <script>
        window.history.pushState(null, "", window.location.href); // Push an empty state
window.onpopstate = function() {
    window.history.pushState(null, "", window.location.href); // Reset the state when going back
};
    </script>
<head>
    <meta charset="UTF-8">
...
<body>
    <img src="logomain.png" alt="" style="height=12%;width:12%;margin-left:20%;display: block; margin: 0 auto;">
    <div>
        <button onclick="run()" style="
background: radial-gradient(circle at 7% 14%, rgb(68, 100, 126) 20.8%, rgb(0, 255, 250) 100.2%);
margin-top : 5%;
margin-left : 8%;
width:7%;
...
"
  onmouseover="this.style.boxShadow='0 0 15px 0 rgba(255, 255, 255, 0.8)';"
  onmouseout="this.style.boxShadow='0 0 10px 0 rgba(255, 255, 255, 0.5)';"><a href="./site.php" style="color:white;text-decoration:none;">Home</a></button>
  <button style="
background: radial-gradient(circle at 7% 14%, rgb(68, 100, 126) 20.8%, rgb(0, 255, 250) 100.2%);
width:7%;
margin-left: 70%;
...
"
  onmouseover="this.style.boxShadow='0 0 15px 0 rgba(255, 255, 255, 0.8)';"
  onmouseout="this.style.boxShadow='0 0 10px 0 rgba(255, 255, 255, 0.5)';"><a href="./user.php" style="color:white;text-decoration:none;">User Logged in</a></button>
