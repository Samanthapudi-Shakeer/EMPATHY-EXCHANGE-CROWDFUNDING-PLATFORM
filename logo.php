...
<div style="margin-top: 0px; margin-left: 50px;">
  ...
  <h1>Welcome <a style="font-size: 4rem; color: white;">&nbsp<?php echo $username ?></a></h1>
</div>
    <script>
        // Function to redirect after 10 seconds
        function redirect() {
            setTimeout(function() {
                window.location.href = 'site.php'; // Replace 'your-next-page.html' with the URL of the page you want to redirect to
            }, 10000); // 10kms = 1s
        }
