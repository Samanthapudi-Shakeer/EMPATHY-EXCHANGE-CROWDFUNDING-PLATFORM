...
<body>
  <div class="open">
    ...
    <a href="./user.php" style="font-size:22px;">User</a>
    <a href="./dlsite.php" style="font-size:22px;">Logout</a>
  ...
  <div class="full">
    ...
    <div class="content">
      <p class="content1">We greatly appreciate your support in aiding individuals with essential needs, food, medical
        care, education, and financial assistance. Through programs in <span class="education">Education</span>, <span
          class="activism">Food for hunger</span> and <span class="science">Medical care.</span> <br> We advocate for
        global change to support a circular economy and
    ...
    <div class="main">
      <div class="image-container" style="margin-left:22%">
        ...
        <div class="image-letter" style="color:white;font-weight:bold;"><p>Required</p>
      ...
      <div class="image-container">
        ...
        <p>Required</p>
          <p><?php echo '<p style="text-align:center;">&#8377;</p> ' . $totalm_amount; ?></p>
        </div>
        <div class="image-description">
      ...
      <div class="image-container">
        ...
        <div class="image-letter" style="color:white;font-weight:bold;">
        <p>Required</p>
          <p><?php echo '<p style="text-align:center;">&#8377;</p> ' . $totalfi_amount; ?></p>
        </div>
        <div class="image-description">
                      ...
                      <div id='About'>
                        <div id='AboutInfo'>
                          <div id='AboutInfoText'>
                            <span>
                            <a href='http://localhost/Mysite/mainsite.php?name=$row[fname]'>
                              <h1>Donate Now</h1>
                            </a>
                            </span>
                            <span>
    ...
    <footer class="footer">
      ...
      <div class="col col2">
        <p><a
            href="https://docs.google.com/presentation/d/1EPFfd3OZ_33mu2QO5w69dtVnJFFo6Wc2HZGRIKA0gH8/edit#slide=id.g2700700d4db_0_13">About</a>
        </p>
        <p><a href="https://docs.google.com/document/d/12-uwTV_r7ZNUXucuWMrEj4l1vyeUYZJeyxlf4W6-SjE/edit">Our
            mission</a></p>
        <p><a href="mailto:shannus084@gmail.com">Privacy Policy</a></p>
        <p><a href="mailto:shannus048@gmail.com">Terms of service</a></p>
      ...
      <div class="col col3">
        <p><a href="mailto:shannus084@gmail.com">Services</a></p>
        <p><a href="mailto:shannus084@gmail.com">Products</a></p>
        <p><a href="mailto:shannus084@gmail.com">Join our team</a></p>
        <p><a href="mailto:shannus084@gmail.com">Partner with us</a></p>
